...
<!-- REQUIRED SCRIPTS -->
<!-- jQuery -->
<!--<script src="vistas/librerias/dist/jquery/jquery.min.js"></script>
-->
<script src="DataTables/datatables.min.js" ></script>
<!-- Bootstrap -->
<script src="vistas/librerias/dist/bootstrap/js/bootstrap.bundle.min.js"></script>
<!--data tables script de funcion -->
<script type="text/javascript">
...
<!-- overlayScrollbars -->
<script src="vistas/librerias/dist/js/jquery.overlayScrollbars.min.js"></script>
